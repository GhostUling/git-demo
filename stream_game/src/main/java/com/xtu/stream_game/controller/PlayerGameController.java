...
public class PlayerGameController {
    ...
    public ResponseEntity<List<PlayerGame>> getGamesByPlayer(@PathVariable int playerId) {
    ...
    public ResponseEntity<List<PlayerGame>> getPlayersByGame(@PathVariable int gameId) {
    ...
    public ResponseEntity<PlayerGame> getPlayerGame(@PathVariable int playerId, @PathVariable int gameId) {
    ...
    public ResponseEntity<List<PlayerGame>> getPlayerGamesSortedByPlayTime(@PathVariable int playerId) {
    ...
    public ResponseEntity<List<PlayerGame>> getPlayerGamesSortedByLastPlayed(@PathVariable int playerId) {
    ...
    // 更新玩家游戏信息
    @PutMapping("/{id}")
    public ResponseEntity<PlayerGame> updatePlayerGame(@PathVariable int id, @RequestBody PlayerGame playerGameDetails) {
    ...
    // 移除玩家游戏记录
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> removePlayerGame(@PathVariable int id) {
